...
export const systemSettingsSchema = z.object({
  ...
  waitlistEnd: dateStr,
  call1RegistrationStartAt: instantWithOffsetSchema.nullable().optional(),
  call1RegistrationEndAt: instantWithOffsetSchema.nullable().optional(),
  call1InProgressStartAt: instantWithOffsetSchema.nullable().optional(),
  call1InProgressEndAt: instantWithOffsetSchema.nullable().optional(),
  call2RegistrationStartAt: instantWithOffsetSchema.nullable().optional(),
  call2RegistrationEndAt: instantWithOffsetSchema.nullable().optional(),
  call2InProgressStartAt: instantWithOffsetSchema.nullable().optional(),
  call2InProgressEndAt: instantWithOffsetSchema.nullable().optional(),
  waitlistRegistrationStartAt: instantWithOffsetSchema.nullable().optional(),
  waitlistRegistrationEndAt: instantWithOffsetSchema.nullable().optional(),
  waitlistInProgressStartAt: instantWithOffsetSchema.nullable().optional(),
  waitlistInProgressEndAt: instantWithOffsetSchema.nullable().optional(),
  notifyCandidate: z.boolean(),
  autoRejectPendingAfterDeadline: z.boolean(),
  autoRejectPendingComment: z.string().trim().min(1, "Informe a mensagem do indeferimento automático.").max(4_000),
